-- Drop
DROP TABLE IF EXISTS academic_forum.articles;
DROP TABLE IF EXISTS academic_forum.books;
DROP TABLE IF EXISTS academic_forum.comments;
DROP TABLE IF EXISTS academic_forum.essential_info;
...
-- 1.1 Essential Info
CREATE TABLE academic_forum.essential_info
(
    infoId int NOT NULL,
...
(
    ...
    CONSTRAINT infoId FOREIGN KEY (commentInfoId)
        REFERENCES academic_forum.essential_info (infoId) MATCH SIMPLE
        ON UPDATE CASCADE
        ON DELETE CASCADE
        NOT VALID
);
...
-- 2.1 Essential Info
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(1, 'The Thursday Murder Club', 'Richard Osman', '2020-09-03', 'https://cdn.waterstones.com/bookjackets/large/9780/2419/9780241988268.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(2, 'The Vanishing Half ', 'Brit Bennett ', '2020-06-02', 'https://cdn.waterstones.com/bookjackets/large/9780/3497/9780349701479.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(3, 'The Bomber Mafia', 'Malcolm Gladwell', '2021-04-27', 'https://cdn.waterstones.com/override/v2/large/2928/3770/2928377055929.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(4, 'Camino Winds', 'John Grisham ', '2020-04-28', 'https://cdn.waterstones.com/bookjackets/large/9781/5293/9781529342499.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(5, 'Don Quixote de la Mancha', 'Miguel De Cervantes Saavedra', '2008-06-12', 'https://cdn.waterstones.com/bookjackets/large/9780/1995/9780199537891.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(6, 'The Well Gardened Mind', 'Sue Stuart-Smith ', '2020-04-16', 'https://cdn.waterstones.com/bookjackets/large/9780/0081/9780008100735.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(7, 'Surviving the Krays', 'David Teale ', '2021-03-18', 'https://cdn.waterstones.com/bookjackets/large/9781/5291/9781529106893.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(8, 'Harry Potter and the Order of the Phoenix', 'J. K. Rowling ', '2014-09-01', 'https://cdn.waterstones.com/bookjackets/large/9781/4088/9781408855690.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(9, 'Animal Farm: 60th Anniversary edition', 'George Orwell', '2020-04-15', 'https://cdn.waterstones.com/bookjackets/large/9781/8465/9781846553547.jpg');

INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(10, 'Design of super-tough and antibacterial PPR/nano-ZnO composites based on the excellent dispersion of ZnO particles', 'Chaojie Huang, Wenjie Mou, Liangzhi Zhao', '2021-04-13', 'https://onlinelibrary.wiley.com/cms/asset/fe0fd80e-5803-4566-b7d4-b1a75cde311e/pola.v59.10.cover.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(11, 'On the comprehension of application programming interface usability in game engines', 'Akhila Sri Manasa Venigalla, Sridhar Chimalakonda', '2021-05-13', 'https://onlinelibrary.wiley.com/cms/asset/85ef013f-ebe9-4b8c-b93e-18a8ac1309c4/spe.v51.6.cover.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(12, 'Optimization of medium-chain-length polyhydroxyalkanoate production by Pseudomonas putida KT2440 from co-metabolism of glycerol and octanoate', 'Ying Li, Songyuan Yang, Dayao Jin, Xiaoqiang Jia', '2020-10-06', 'https://onlinelibrary.wiley.com/cms/asset/bc05bfcc-9dc2-4a2c-9402-7f8718f1f316/cjce.v99.3.cover.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(13, 'Back contacts materials used in thin film CdTe solar cells—A review', 'Ralph Stephen Hall, Dan Lamb, Stuart James Curzon Irvine', '2021-02-10', 'https://onlinelibrary.wiley.com/cms/asset/53b359f6-cf66-4c39-9159-8ecbe9c6fec8/ese3.v9.5.cover.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(14, 'Structural analysis and design of irregular shaped footings subjected to eccentric loading', 'Mohammed S. Al-Ansari, Muhammad S. Afzal', '2020-09-14', 'https://onlinelibrary.wiley.com/cms/asset/011c5627-0a66-47b4-99fa-95ff1ec4bbae/eng2.v3.1.cover.jpg');
INSERT INTO academic_forum.essential_info(infoId, title, author, publicationDate, urlCoverPhoto)VALUES(15, 'Micro-computed tomography for the 3D time-resolved investigation of monodisperse droplet generation in a co-flow setup', 'Julia Schuler, Laura Maria Neuendorf, Kai Petersen, Norbert Kockmann', '2020-11-01', 'https://aiche.onlinelibrary.wiley.com/cms/asset/ddfdb4d3-b50a-4afc-8ff7-8883420a385e/aic.v67.2.cover.jpg');
...
-- 2.4 Articles
INSERT INTO academic_forum.articles(article_id, journalIssueNumber, journalPublished, articleInfoId)VALUES(1, 10, 'Journal of Polymer Science', 10);
INSERT INTO academic_forum.articles(article_id, journalIssueNumber, journalPublished, articleInfoId)VALUES(2, 6, 'Software: Practice and Experience', 11);
INSERT INTO academic_forum.articles(article_id, journalIssueNumber, journalPublished, articleInfoId)VALUES(3, 3, 'The Canadian Journal of Chemical Engineering', 12);
INSERT INTO academic_forum.articles(article_id, journalIssueNumber, journalPublished, articleInfoId)VALUES(4, 5, 'Energy Science & Engineering', 13);
INSERT INTO academic_forum.articles(article_id, journalIssueNumber, journalPublished, articleInfoId)VALUES(5, 1, 'Engineering Reports', 14);
INSERT INTO academic_forum.articles(article_id, journalIssueNumber, journalPublished, articleInfoId)VALUES(6, 2, 'AIChE Journal', 15);
